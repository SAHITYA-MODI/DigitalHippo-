...
import { ArrowBigDown, ArrowDownToLine, CheckCircle, Leaf } from "lucide-react";
...
export default function Home() {
  const perks = [
    ...
    },
    {
      ...
      icon: CheckCircle,
      description:
        "Every assets on our platform is verified by our team to ensure our highest quality standard. Not happy? We offer a 30-day refund guarantee period.",
    },
    {
      name: "For the planet",
      icon: Leaf,
